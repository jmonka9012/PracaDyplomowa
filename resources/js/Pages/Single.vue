        ...
        <div class="container container-small">
            <div class="single__content">
                ...
                <h1 class="single__title">
                    Festival of Japanese Culture in Berlin 2022
                </h1>
                <div class="single__details">
                    <div>
                        <h6 class="mb-13px">Event date:</h6>
                        <p>
                            Start at 12:00 AM <br />
                            December 27, 2022 - <br />
                            December 29, 2022
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <a class="hover-none" href="">city@vox.com.ua</a>
                        <a class="hover-none" href="">thegov@gmail.com</a>
                    </div>
                </div>
                <h4 class="mb-18px">About Festival</h4>
                <ul class="list-stars list-stars-prpl mb-35px">
                    <li>
                        Ultricies mauris pharetra et ultrices neque ornare
                        nascetur aenean.
                    </li>
                    <li>
                    ...
                    <li>
                        Eget sit amet tellus cras tincidunt adipiscing enim eu
                        turpis.
                    </li>
                    <li>
                        Ornare arcu dui vivamus arcu consectetur felis bibendum.
                    </li>
                </ul>
                <p class="mb-65px">
                    Blandit cursus risus at ultrices sed tempus imperdiet nulla
                    malesuada. Faucibus in ornare quam viverra orci sagittis eu
                    magnis volutpat odio.
                </p>
                <h4 class="mb-18px">More Information</h4>
                <p class="mb-65px">
                    Mattis rhoncus urna neque viverra. Leo vitae turpis massa
                    elementum tempus. Enim nulla aliquet porttitor lacus a
                    accumsan tortor posuere. Euismod elementum nisi quis
                    eleifend adipiscing vitae proin. Sagittis aliquam malesuada
